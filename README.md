...
- [订阅机场](#订阅机场)
- [Windows](#windows)
  - [安装Clash Verge Rev](#安装clash-verge-rev)
  - [导入订阅链接](#导入订阅链接-windows)
  - [打开系统代理](#打开系统代理-windows)
  - [选择代理模式和节点](#选择代理模式和节点)
  - [更新订阅](#更新订阅)
- [Android](#android)
  - [安装Clash Meta for Android](#安装clash-meta-for-android)
  - [导入订阅链接](#导入订阅链接-android)
  - [打开系统代理](#打开系统代理-android)
  - [设置快捷开关（可选）](#设置快捷开关可选)
- [小贴士](#小贴士)
  - [选择合适的Clash代理模式](#选择合适的clash代理模式)
  - [Windows突然无法上网](#windows突然无法上网)
